...
class Tag {
    ...
    fix() {
        ...
        } else if (this.debug) console.log('No fix required')
    }
    ...
    set name(name) {
        ...
        if (typeof name === 'string') {
            // rename using element.outerHTML
            if (this.element) this.element.outerHTML = this.element.outerHTML.replace(new RegExp(this.element.name, 'g'), name)
            else this.element = document.createElement(name)
